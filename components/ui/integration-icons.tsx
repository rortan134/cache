...
export const SoundCloud = (props: SVGProps<SVGSVGElement>) => {
    const { className, ...rest } = props;
    ...
    return (
        ...
        >
            <path
                d="M183.547 60.753C178.978 35.557 156.94 16.5 130.5 16.5c-6.658 0-13.076 1.195-19.016 3.379a4 4 0 0 0-2.625 3.756V143.5h99.141c26.135 0 47.5-21.365 47.5-47.5s-21.365-47.5-47.5-47.5c-8.6 0-16.62 2.314-23.453 6.253Z"
                fill="#FF5500"
            />
            <path
                d="M92.859 28.217a4 4 0 0 0-6.164-3.35A61.86 61.86 0 0 0 78.43 31.5a4 4 0 0 0-1.712 3.283V143.5h16.141V28.217ZM61.219 49.232a4 4 0 0 0-6.398-3.135 62.43 62.43 0 0 0-7.974 7.268 4 4 0 0 0-1.129 2.766V143.5h15.5V49.232ZM30.359 80.179a4 4 0 0 0-6.953-2.683A61.755 61.755 0 0 0 .5 120.5c0 8.15 1.574 15.932 4.43 23.06a4 4 0 0 0 3.714 2.44h21.715V80.179ZM15.719 97.855a4 4 0 0 0-6.984-2.577A61.618 61.618 0 0 0 0 120.5c0 6.532 1.012 12.828 2.889 18.744a4 4 0 0 0 3.812 2.756h9.018V97.855ZM46.578 61.828a4 4 0 0 0-6.645-3.02 62.09 62.09 0 0 0-9.574 11.766 4 4 0 0 0-.5 1.94V143.5h16.719V61.828Z"
                fill="#FF5500"
            />
        </svg>
    );
