...
import { AlertDialog as AlertDialogParts } from "@base-ui/react/alert-dialog";
import type React from "react";
import { cn } from "@/lib/utils";

export const AlertDialogCreateHandle: typeof AlertDialogParts.createHandle =
    AlertDialogParts.createHandle;

export const AlertDialog: typeof AlertDialogParts.Root = AlertDialogParts.Root;

export const AlertDialogPortal: typeof AlertDialogParts.Portal =
    AlertDialogParts.Portal;

export function AlertDialogTrigger(
    props: AlertDialogParts.Trigger.Props
): React.ReactElement {
    return (
        <AlertDialogParts.Trigger data-slot="alert-dialog-trigger" {...props} />
    );
}
...
export function AlertDialogBackdrop({
    className,
    ...props
}: AlertDialogParts.Backdrop.Props): React.ReactElement {
    return (
        <AlertDialogParts.Backdrop
            className={cn(
...
export function AlertDialogViewport({
    className,
    ...props
}: AlertDialogParts.Viewport.Props): React.ReactElement {
    return (
        <AlertDialogParts.Viewport
            className={cn(
...
export function AlertDialogTitle({
    className,
    ...props
}: AlertDialogParts.Title.Props): React.ReactElement {
    return (
        <AlertDialogParts.Title
            className={cn(
...
export function AlertDialogDescription({
    className,
    ...props
}: AlertDialogParts.Description.Props): React.ReactElement {
    return (
        <AlertDialogParts.Description
...
export function AlertDialogClose(
    props: AlertDialogParts.Close.Props
): React.ReactElement {
    return <AlertDialogParts.Close data-slot="alert-dialog-close" {...props} />;
}
